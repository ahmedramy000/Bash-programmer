// ==================================================================================
//  باش مبرمج — نظام المراكز والشهادات
...
const CERT_TIERS = [
  {
    ...
    message: (name)=> `تُشهد منصة "باش مبرمج" بأن الطالب/ة ${name} حقق/حققت المركز الأول بامتياز مذهل، ` +
  ...
  },
  {
    ...
    message: (name)=> `تُشهد منصة "باش مبرمج" بأن الطالب/ة ${name} حقق/حققت المركز الثاني بتفوّق ملحوظ، ` +
  ...
  },
  {
    ...
    requireAllUnits: true,
    requireAllExams: false,
    message: (name)=> `تُشهد منصة "باش مبرمج" بأن الطالب/ة ${name} حقق/حققت المركز الثالث بتقدير امتياز، ` +
  ...
  },
  {
    ...
    minScore: 0.70,
    minAttempted: 14,
    message: (name)=> `تُشهد منصة "باش مبرمج" بأن الطالب/ة ${name} حصل/حصلت على شهادة تفوّق ` +
  ...
  },
  {
    ...
    minScore: 0.5,
    minAttempted: 9,
    message: (name)=> `تُشهد منصة "باش مبرمج" بأن الطالب/ة ${name} حصل/حصلت على شهادة إنجاز ` +
  ...
  },
  {
    ...
    minScore: 0,
    minAttempted: 1,
    message: (name)=> `تُشهد منصة "باش مبرمج" بأن الطالب/ة ${name} بدأ/بدأت رحلة المراجعة على المنصة. ` +
...
function drawCertificate(canvas, data, overrideName){
  ...
  ctx.fillText('باش مبرمج', W/2, H*0.10);
